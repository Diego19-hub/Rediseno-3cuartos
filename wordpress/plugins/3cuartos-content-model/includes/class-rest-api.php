...
final class RestApi {
	...
	public static function append_public_meta( WP_REST_Response $response, WP_Post $post, WP_REST_Request $request ): WP_REST_Response {
		$fields = array(
			...
			'3cuartos_case_study' => array( '3cuartos_client_name', '3cuartos_challenge', '3cuartos_solution', '3cuartos_service_ids', '3cuartos_results', '3cuartos_metrics', '3cuartos_gallery_ids', '3cuartos_testimonial_id', '3cuartos_cta', '3cuartos_seo', '3cuartos_is_provisional' ),
